...
@Component
@Slf4j
public class BlockFollowStaticCurrent4PlankComponent {
    @Autowired
        ...
        for (String tradeDate:pairsMap.keySet()) {
            ...
            *//*if(tradeDate.equals("20220518")){
            ...
            THREAD_POOL_QUOTE_4PLANK.execute(() ->{
                ...
                BlocKFollowStaticTotalDTO blocKFollowStaticTotalDTO = blockBuys(4,blockInfos, plankTimePairDTOS, circulateInfoMap, tradeDate);
