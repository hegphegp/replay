...
public class StockFactorTestTwoComponent {
    ...
    public List<StockFactorLevelTestDTO> getPlankTimePairs(Map<String, CirculateInfo> circulateInfoMap,List<TradeDatePool> tradeDatePools){
        ...
        for (TradeDatePool tradeDatePool:tradeDatePools){
            ...
            if(tradeDatePool.getTradeDate().after(DateUtil.parseDate("20181231", DateUtil.yyyyMMdd))){
                continue;
            }
            i++;
    ...
    public Map<String, Integer> getMarketBigStocks(Map<String,CirculateInfo> circulateInfoMap, String tradeDate){
